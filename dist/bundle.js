...
var css = "#lightning{z-index:5;position:absolute;top:0;left:0;height:var(--weather-height);width:var(--frame-width);opacity:0;animation:lightningDay 10s linear infinite -6s}.night #lightning{animation:lightningNight 10s linear infinite -6s}@keyframes lightningDay{98.5%{opacity:0}99%{opacity:1;background:#ffffe6}100%{opacity:0}}@keyframes lightningNight{98.5%{opacity:0}99%{opacity:1;background:#ffffc8}100%{opacity:0}}\n"
module.exports = require('scssify').createStyle(css, {})
