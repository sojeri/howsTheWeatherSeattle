;(function() {
...
})()(
    {
        ...
        5: [
            ...
            { '../view/addMoonToDOM': 12, './fetchJsonResource': 3, './weatherAPIs': 8 },
        ],
        6: [
            function(require, module, exports) {
        ...
        9: [
            ...
            },
            {
                './data/loadMoon': 5,
                './data/loadWeather': 6,
                './view/addAboutToDOM': 10,
                './view/styles/index.scss': 22,
            },
        ],
        10: [
            function(require, module, exports) {
            ...
            { '../data/DOMutils': 2, '../data/utils/logError': 7, './styles/about.scss': 17 },
        ],
        11: [
            function(require, module, exports) {
            ...
            {
                './styles/cloud-like-weather/clouds.scss': 18,
                './styles/cloud-like-weather/mist.scss': 19,
                './styles/cloud-like-weather/smoke.scss': 20,
                './styles/cloud-like-weather/storm.scss': 21,
                './utils/addClass': 30,
                './utils/weatherTypes': 35,
            },
        ],
        12: [
            function(require, module, exports) {
            ...
            { './utils/addClass': 30, './utils/reportModuleLoaded': 34 },
        ],
        13: [
            function(require, module, exports) {
                const addClass = require('./utils/addClass')
            ...
            {
                './styles/rain-like-weather/heavyFalling.scss': 24,
                './styles/rain-like-weather/lightFalling.scss': 25,
                './styles/rain-like-weather/mediumFalling.scss': 26,
                './styles/rain-like-weather/snowFalling.scss': 27,
                './utils/addClass': 30,
                './utils/weatherTypes': 35,
            },
        ],
        ...
        15: [
            ...
            },
            {
                './addCloudsToDOM': 11,
                './addRainToDOM': 13,
                './addWeatherDataToDOM': 14,
                './addWindToDOM': 16,
                './styles/night.scss': 23,
                './styles/sun-and-moon.scss': 28,
                './utils/addClass': 30,
                './utils/getWeatherClassName': 32,
                './utils/isGreatWheelOpen': 33,
                './utils/reportModuleLoaded': 34,
                './utils/weatherTypes': 35,
            },
        ],
        16: [
            ...
            { './styles/wind.scss': 29, './utils/addClass': 30, './utils/getCardinalWindDirection': 31 },
        ],
        17: [
            function(require, module, exports) {
                var css =
        ...
        23: [
            function(require, module, exports) {
                var css =
                    '.night{background:#136}.night .cloud,.night .puff,.night .cloud:after,.night .puff:after{background:rgba(150,150,150,0.8)}.night.light .cloud,.night.light .puff,.night.light .cloud:after,.night.light .puff:after{background:rgba(150,150,150,0.7)}.night.heavy .cloud,.night.heavy .puff,.night.heavy .cloud:after,.night.heavy .puff:after{background:rgba(150,150,150,0.9)}.night.mist .cloud,.night.mist .puff,.night.mist .cloud:after,.night.mist .puff:after{background:rgba(150,150,200,0.4)}.night.smoke .cloud,.night.smoke .puff,.night.smoke .cloud:after,.night.smoke .puff:after{background:rgba(150,100,50,0.2)}.star{z-index:1;position:absolute;box-shadow:0 0 1px 1px #fff}.star-1{top:57%;left:27%}.star-2{top:88%;left:14%}.star-3{top:50%;left:100%}.star-4{top:47%;left:97%}.star-5{top:88%;left:43%}.star-6{top:78%;left:16%}.star-7{top:54%;left:11%}.star-8{top:54%;left:48%}.star-9{top:61%;left:55%}.star-10{top:10%;left:81%}.star-11{top:96%;left:39%}.star-12{top:89%;left:46%}.star-13{top:64%;left:31%}.star-14{top:28%;left:63%}.star-15{top:35%;left:59%}.star-16{top:26%;left:13%}.star-17{top:28%;left:100%}.star-18{top:34%;left:75%}.star-19{top:98%;left:12%}.star-20{top:35%;left:28%}.star-21{top:10%;left:67%}.star-22{top:60%;left:52%}.star-23{top:22%;left:6%}.star-24{top:93%;left:71%}.star-25{top:20%;left:62%}.star-26{top:39%;left:9%}.star-27{top:47%;left:48%}.star-28{top:40%;left:8%}.star-29{top:31%;left:89%}.star-30{top:16%;left:72%}\n'
                module.exports = require('scssify').createStyle(css, {})
            },
            { scssify: 1 },
        ],
        24: [
            function(require, module, exports) {
                var css =
                    '.cloud,.puff,.cloud:after,.puff:after{position:absolute;background:rgba(255,255,255,0.8);border-radius:50%;z-index:7}.light .cloud,.light .puff,.light .cloud:after,.light .puff:after{background:rgba(255,255,255,0.7);transform:scale(0.7) translateY(-30%)}.heavy .cloud,.heavy .puff,.heavy .cloud:after,.heavy .puff:after{background:rgba(255,255,255,0.9);transform:scale(1.6) translateY(-30%)}.isFalling .cloud,.isFalling .puff,.isFalling .cloud:after,.isFalling .puff:after{background:rgba(255,255,255,0.8)}.cloud,.cloud:after{height:var(--base-width);filter:blur(calc(var(--base-width) * 0.1))}.puff,.puff:after{height:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 2.5);filter:blur(calc(var(--base-width) * 0.15))}.cloud.one{top:calc(var(--base-width) * -0.1);left:calc(var(--base-width) * -0.3);width:calc(var(--base-width) * 5)}.cloud.one:after{width:calc(var(--base-width) * 5)}.cloud.two{top:calc(var(--base-width) * 0.4);left:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 3)}.cloud.two:after{width:calc(var(--base-width) * 3)}.cloud.three{top:calc(var(--base-width) * 0.8);left:calc(var(--base-width) * 1.8);width:calc(var(--base-width) * 4)}.cloud.three:after{width:calc(var(--base-width) * 4)}.puff.one{top:calc(var(--base-width) * 1.2);left:calc(var(--base-width) * 0.2)}.puff.two{top:calc(var(--base-width) * 1.4);left:calc(var(--base-width) * 1.2)}.puff.three{top:calc(var(--base-width) * 0.5);left:calc(var(--base-width) * 3.3)}.isFalling .weather{z-index:6;position:absolute;top:calc(var(--frame-width) / -40);opacity:0;border-radius:50%}.tiny.weather{height:16px;width:8px;background:rgba(100,130,255,0.6)}.weather-1{left:36.36364px}@keyframes falling-1{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:48.86364px}}.wind-east .weather-1{left:36.36364px}@keyframes falling-1-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:13.63636px}}.wind-east.wind-med .weather-1{left:81.81818px}@keyframes falling-1-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-9.09091px}}.wind-east.wind-high .weather-1{left:127.27273px}@keyframes falling-1-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-54.54545px}}.wind-west .weather-1{left:-54.54545px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west.wind-med .weather-1{left:-9.09091px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:81.81818px}}.wind-west.wind-high .weather-1{left:-54.54545px}@keyframes falling-1-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.weather-2{left:72.72727px}@keyframes falling-2{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:85.22727px}}.wind-east .weather-2{left:72.72727px}@keyframes falling-2-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:50px}}.wind-east.wind-med .weather-2{left:118.18182px}@keyframes falling-2-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:27.27273px}}.wind-east.wind-high .weather-2{left:163.63636px}@keyframes falling-2-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-18.18182px}}.wind-west .weather-2{left:-18.18182px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west.wind-med .weather-2{left:27.27273px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:118.18182px}}.wind-west.wind-high .weather-2{left:-18.18182px}@keyframes falling-2-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.weather-3{left:109.09091px}@keyframes falling-3{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:121.59091px}}.wind-east .weather-3{left:109.09091px}@keyframes falling-3-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:86.36364px}}.wind-east.wind-med .weather-3{left:154.54545px}@keyframes falling-3-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:63.63636px}}.wind-east.wind-high .weather-3{left:200px}@keyframes falling-3-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:18.18182px}}.wind-west .weather-3{left:18.18182px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west.wind-med .weather-3{left:63.63636px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:154.54545px}}.wind-west.wind-high .weather-3{left:18.18182px}@keyframes falling-3-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.weather-4{left:145.45455px}@keyframes falling-4{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:157.95455px}}.wind-east .weather-4{left:145.45455px}@keyframes falling-4-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:122.72727px}}.wind-east.wind-med .weather-4{left:190.90909px}@keyframes falling-4-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:100px}}.wind-east.wind-high .weather-4{left:236.36364px}@keyframes falling-4-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:54.54545px}}.wind-west .weather-4{left:54.54545px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west.wind-med .weather-4{left:100px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:190.90909px}}.wind-west.wind-high .weather-4{left:54.54545px}@keyframes falling-4-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.weather-5{left:181.81818px}@keyframes falling-5{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:194.31818px}}.wind-east .weather-5{left:181.81818px}@keyframes falling-5-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:159.09091px}}.wind-east.wind-med .weather-5{left:227.27273px}@keyframes falling-5-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:136.36364px}}.wind-east.wind-high .weather-5{left:272.72727px}@keyframes falling-5-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:90.90909px}}.wind-west .weather-5{left:90.90909px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west.wind-med .weather-5{left:136.36364px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:227.27273px}}.wind-west.wind-high .weather-5{left:90.90909px}@keyframes falling-5-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.weather-6{left:218.18182px}@keyframes falling-6{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:230.68182px}}.wind-east .weather-6{left:218.18182px}@keyframes falling-6-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:195.45455px}}.wind-east.wind-med .weather-6{left:263.63636px}@keyframes falling-6-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:172.72727px}}.wind-east.wind-high .weather-6{left:309.09091px}@keyframes falling-6-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west .weather-6{left:127.27273px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.wind-west.wind-med .weather-6{left:172.72727px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:263.63636px}}.wind-west.wind-high .weather-6{left:127.27273px}@keyframes falling-6-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.weather-7{left:254.54545px}@keyframes falling-7{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:267.04545px}}.wind-east .weather-7{left:254.54545px}@keyframes falling-7-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:231.81818px}}.wind-east.wind-med .weather-7{left:300px}@keyframes falling-7-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:209.09091px}}.wind-east.wind-high .weather-7{left:345.45455px}@keyframes falling-7-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west .weather-7{left:163.63636px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.wind-west.wind-med .weather-7{left:209.09091px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:300px}}.wind-west.wind-high .weather-7{left:163.63636px}@keyframes falling-7-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.weather-8{left:290.90909px}@keyframes falling-8{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:303.40909px}}.wind-east .weather-8{left:290.90909px}@keyframes falling-8-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:268.18182px}}.wind-east.wind-med .weather-8{left:336.36364px}@keyframes falling-8-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:245.45455px}}.wind-east.wind-high .weather-8{left:381.81818px}@keyframes falling-8-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west .weather-8{left:200px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.wind-west.wind-med .weather-8{left:245.45455px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:336.36364px}}.wind-west.wind-high .weather-8{left:200px}@keyframes falling-8-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.weather-9{left:327.27273px}@keyframes falling-9{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:339.77273px}}.wind-east .weather-9{left:327.27273px}@keyframes falling-9-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:304.54545px}}.wind-east.wind-med .weather-9{left:372.72727px}@keyframes falling-9-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:281.81818px}}.wind-east.wind-high .weather-9{left:418.18182px}@keyframes falling-9-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west .weather-9{left:236.36364px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.wind-west.wind-med .weather-9{left:281.81818px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:372.72727px}}.wind-west.wind-high .weather-9{left:236.36364px}@keyframes falling-9-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.weather-10{left:363.63636px}@keyframes falling-10{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:376.13636px}}.wind-east .weather-10{left:363.63636px}@keyframes falling-10-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:340.90909px}}.wind-east.wind-med .weather-10{left:409.09091px}@keyframes falling-10-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:318.18182px}}.wind-east.wind-high .weather-10{left:454.54545px}@keyframes falling-10-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west .weather-10{left:272.72727px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.wind-west.wind-med .weather-10{left:318.18182px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:409.09091px}}.wind-west.wind-high .weather-10{left:272.72727px}@keyframes falling-10-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.tiny.weather-1{animation:falling-1 1.3s infinite linear 1.4s}.wind-east .tiny.weather-1{animation:falling-1-east 1.3s infinite linear 1.4s}.wind-east.wind-med .tiny.weather-1{animation:falling-1-east-med 1.3s infinite linear 1.4s}.wind-east.wind-high .tiny.weather-1{animation:falling-1-east-high 1.3s infinite linear 1.4s}.wind-west .tiny.weather-1{animation:falling-1-west 1.3s infinite linear 1.4s}.wind-west.wind-med .tiny.weather-1{animation:falling-1-west-med 1.3s infinite linear 1.4s}.wind-west.wind-high .tiny.weather-1{animation:falling-1-west-high 1.3s infinite linear 1.4s}.tiny.weather-2{animation:falling-2 2s infinite linear .4s}.wind-east .tiny.weather-2{animation:falling-2-east 2s infinite linear .4s}.wind-east.wind-med .tiny.weather-2{animation:falling-2-east-med 2s infinite linear .4s}.wind-east.wind-high .tiny.weather-2{animation:falling-2-east-high 2s infinite linear .4s}.wind-west .tiny.weather-2{animation:falling-2-west 2s infinite linear .4s}.wind-west.wind-med .tiny.weather-2{animation:falling-2-west-med 2s infinite linear .4s}.wind-west.wind-high .tiny.weather-2{animation:falling-2-west-high 2s infinite linear .4s}.tiny.weather-3{animation:falling-3 1.3s infinite linear .2s}.wind-east .tiny.weather-3{animation:falling-3-east 1.3s infinite linear .2s}.wind-east.wind-med .tiny.weather-3{animation:falling-3-east-med 1.3s infinite linear .2s}.wind-east.wind-high .tiny.weather-3{animation:falling-3-east-high 1.3s infinite linear .2s}.wind-west .tiny.weather-3{animation:falling-3-west 1.3s infinite linear .2s}.wind-west.wind-med .tiny.weather-3{animation:falling-3-west-med 1.3s infinite linear .2s}.wind-west.wind-high .tiny.weather-3{animation:falling-3-west-high 1.3s infinite linear .2s}.tiny.weather-4{animation:falling-4 1.1s infinite linear .5s}.wind-east .tiny.weather-4{animation:falling-4-east 1.1s infinite linear .5s}.wind-east.wind-med .tiny.weather-4{animation:falling-4-east-med 1.1s infinite linear .5s}.wind-east.wind-high .tiny.weather-4{animation:falling-4-east-high 1.1s infinite linear .5s}.wind-west .tiny.weather-4{animation:falling-4-west 1.1s infinite linear .5s}.wind-west.wind-med .tiny.weather-4{animation:falling-4-west-med 1.1s infinite linear .5s}.wind-west.wind-high .tiny.weather-4{animation:falling-4-west-high 1.1s infinite linear .5s}.tiny.weather-5{animation:falling-5 1.3s infinite linear .9s}.wind-east .tiny.weather-5{animation:falling-5-east 1.3s infinite linear .9s}.wind-east.wind-med .tiny.weather-5{animation:falling-5-east-med 1.3s infinite linear .9s}.wind-east.wind-high .tiny.weather-5{animation:falling-5-east-high 1.3s infinite linear .9s}.wind-west .tiny.weather-5{animation:falling-5-west 1.3s infinite linear .9s}.wind-west.wind-med .tiny.weather-5{animation:falling-5-west-med 1.3s infinite linear .9s}.wind-west.wind-high .tiny.weather-5{animation:falling-5-west-high 1.3s infinite linear .9s}.tiny.weather-6{animation:falling-6 3s infinite linear 1.5s}.wind-east .tiny.weather-6{animation:falling-6-east 3s infinite linear 1.5s}.wind-east.wind-med .tiny.weather-6{animation:falling-6-east-med 3s infinite linear 1.5s}.wind-east.wind-high .tiny.weather-6{animation:falling-6-east-high 3s infinite linear 1.5s}.wind-west .tiny.weather-6{animation:falling-6-west 3s infinite linear 1.5s}.wind-west.wind-med .tiny.weather-6{animation:falling-6-west-med 3s infinite linear 1.5s}.wind-west.wind-high .tiny.weather-6{animation:falling-6-west-high 3s infinite linear 1.5s}.tiny.weather-7{animation:falling-7 2s infinite linear .8s}.wind-east .tiny.weather-7{animation:falling-7-east 2s infinite linear .8s}.wind-east.wind-med .tiny.weather-7{animation:falling-7-east-med 2s infinite linear .8s}.wind-east.wind-high .tiny.weather-7{animation:falling-7-east-high 2s infinite linear .8s}.wind-west .tiny.weather-7{animation:falling-7-west 2s infinite linear .8s}.wind-west.wind-med .tiny.weather-7{animation:falling-7-west-med 2s infinite linear .8s}.wind-west.wind-high .tiny.weather-7{animation:falling-7-west-high 2s infinite linear .8s}.tiny.weather-8{animation:falling-8 1.3s infinite linear .6s}.wind-east .tiny.weather-8{animation:falling-8-east 1.3s infinite linear .6s}.wind-east.wind-med .tiny.weather-8{animation:falling-8-east-med 1.3s infinite linear .6s}.wind-east.wind-high .tiny.weather-8{animation:falling-8-east-high 1.3s infinite linear .6s}.wind-west .tiny.weather-8{animation:falling-8-west 1.3s infinite linear .6s}.wind-west.wind-med .tiny.weather-8{animation:falling-8-west-med 1.3s infinite linear .6s}.wind-west.wind-high .tiny.weather-8{animation:falling-8-west-high 1.3s infinite linear .6s}.tiny.weather-9{animation:falling-9 1.1s infinite linear .3s}.wind-east .tiny.weather-9{animation:falling-9-east 1.1s infinite linear .3s}.wind-east.wind-med .tiny.weather-9{animation:falling-9-east-med 1.1s infinite linear .3s}.wind-east.wind-high .tiny.weather-9{animation:falling-9-east-high 1.1s infinite linear .3s}.wind-west .tiny.weather-9{animation:falling-9-west 1.1s infinite linear .3s}.wind-west.wind-med .tiny.weather-9{animation:falling-9-west-med 1.1s infinite linear .3s}.wind-west.wind-high .tiny.weather-9{animation:falling-9-west-high 1.1s infinite linear .3s}.tiny.weather-10{animation:falling-10 3s infinite linear .3s}.wind-east .tiny.weather-10{animation:falling-10-east 3s infinite linear .3s}.wind-east.wind-med .tiny.weather-10{animation:falling-10-east-med 3s infinite linear .3s}.wind-east.wind-high .tiny.weather-10{animation:falling-10-east-high 3s infinite linear .3s}.wind-west .tiny.weather-10{animation:falling-10-west 3s infinite linear .3s}.wind-west.wind-med .tiny.weather-10{animation:falling-10-west-med 3s infinite linear .3s}.wind-west.wind-high .tiny.weather-10{animation:falling-10-west-high 3s infinite linear .3s}.small.weather{height:26px;width:13px;background:rgba(100,130,255,0.75)}.small.weather-1{animation:falling-1 2.4s infinite linear 1.5s}.wind-east .small.weather-1{animation:falling-1-east 2.4s infinite linear 1.5s}.wind-east.wind-med .small.weather-1{animation:falling-1-east-med 2.4s infinite linear 1.5s}.wind-east.wind-high .small.weather-1{animation:falling-1-east-high 2.4s infinite linear 1.5s}.wind-west .small.weather-1{animation:falling-1-west 2.4s infinite linear 1.5s}.wind-west.wind-med .small.weather-1{animation:falling-1-west-med 2.4s infinite linear 1.5s}.wind-west.wind-high .small.weather-1{animation:falling-1-west-high 2.4s infinite linear 1.5s}.small.weather-2{animation:falling-2 2.7s infinite linear 1.4s}.wind-east .small.weather-2{animation:falling-2-east 2.7s infinite linear 1.4s}.wind-east.wind-med .small.weather-2{animation:falling-2-east-med 2.7s infinite linear 1.4s}.wind-east.wind-high .small.weather-2{animation:falling-2-east-high 2.7s infinite linear 1.4s}.wind-west .small.weather-2{animation:falling-2-west 2.7s infinite linear 1.4s}.wind-west.wind-med .small.weather-2{animation:falling-2-west-med 2.7s infinite linear 1.4s}.wind-west.wind-high .small.weather-2{animation:falling-2-west-high 2.7s infinite linear 1.4s}.small.weather-3{animation:falling-3 1.7s infinite linear 1.1s}.wind-east .small.weather-3{animation:falling-3-east 1.7s infinite linear 1.1s}.wind-east.wind-med .small.weather-3{animation:falling-3-east-med 1.7s infinite linear 1.1s}.wind-east.wind-high .small.weather-3{animation:falling-3-east-high 1.7s infinite linear 1.1s}.wind-west .small.weather-3{animation:falling-3-west 1.7s infinite linear 1.1s}.wind-west.wind-med .small.weather-3{animation:falling-3-west-med 1.7s infinite linear 1.1s}.wind-west.wind-high .small.weather-3{animation:falling-3-west-high 1.7s infinite linear 1.1s}.small.weather-4{animation:falling-4 3s infinite linear .9s}.wind-east .small.weather-4{animation:falling-4-east 3s infinite linear .9s}.wind-east.wind-med .small.weather-4{animation:falling-4-east-med 3s infinite linear .9s}.wind-east.wind-high .small.weather-4{animation:falling-4-east-high 3s infinite linear .9s}.wind-west .small.weather-4{animation:falling-4-west 3s infinite linear .9s}.wind-west.wind-med .small.weather-4{animation:falling-4-west-med 3s infinite linear .9s}.wind-west.wind-high .small.weather-4{animation:falling-4-west-high 3s infinite linear .9s}.small.weather-5{animation:falling-5 2.3s infinite linear .1s}.wind-east .small.weather-5{animation:falling-5-east 2.3s infinite linear .1s}.wind-east.wind-med .small.weather-5{animation:falling-5-east-med 2.3s infinite linear .1s}.wind-east.wind-high .small.weather-5{animation:falling-5-east-high 2.3s infinite linear .1s}.wind-west .small.weather-5{animation:falling-5-west 2.3s infinite linear .1s}.wind-west.wind-med .small.weather-5{animation:falling-5-west-med 2.3s infinite linear .1s}.wind-west.wind-high .small.weather-5{animation:falling-5-west-high 2.3s infinite linear .1s}.small.weather-6{animation:falling-6 1.6s infinite linear .9s}.wind-east .small.weather-6{animation:falling-6-east 1.6s infinite linear .9s}.wind-east.wind-med .small.weather-6{animation:falling-6-east-med 1.6s infinite linear .9s}.wind-east.wind-high .small.weather-6{animation:falling-6-east-high 1.6s infinite linear .9s}.wind-west .small.weather-6{animation:falling-6-west 1.6s infinite linear .9s}.wind-west.wind-med .small.weather-6{animation:falling-6-west-med 1.6s infinite linear .9s}.wind-west.wind-high .small.weather-6{animation:falling-6-west-high 1.6s infinite linear .9s}.small.weather-7{animation:falling-7 1.8s infinite linear .6s}.wind-east .small.weather-7{animation:falling-7-east 1.8s infinite linear .6s}.wind-east.wind-med .small.weather-7{animation:falling-7-east-med 1.8s infinite linear .6s}.wind-east.wind-high .small.weather-7{animation:falling-7-east-high 1.8s infinite linear .6s}.wind-west .small.weather-7{animation:falling-7-west 1.8s infinite linear .6s}.wind-west.wind-med .small.weather-7{animation:falling-7-west-med 1.8s infinite linear .6s}.wind-west.wind-high .small.weather-7{animation:falling-7-west-high 1.8s infinite linear .6s}.small.weather-8{animation:falling-8 2.2s infinite linear .9s}.wind-east .small.weather-8{animation:falling-8-east 2.2s infinite linear .9s}.wind-east.wind-med .small.weather-8{animation:falling-8-east-med 2.2s infinite linear .9s}.wind-east.wind-high .small.weather-8{animation:falling-8-east-high 2.2s infinite linear .9s}.wind-west .small.weather-8{animation:falling-8-west 2.2s infinite linear .9s}.wind-west.wind-med .small.weather-8{animation:falling-8-west-med 2.2s infinite linear .9s}.wind-west.wind-high .small.weather-8{animation:falling-8-west-high 2.2s infinite linear .9s}.small.weather-9{animation:falling-9 1.3s infinite linear 1.4s}.wind-east .small.weather-9{animation:falling-9-east 1.3s infinite linear 1.4s}.wind-east.wind-med .small.weather-9{animation:falling-9-east-med 1.3s infinite linear 1.4s}.wind-east.wind-high .small.weather-9{animation:falling-9-east-high 1.3s infinite linear 1.4s}.wind-west .small.weather-9{animation:falling-9-west 1.3s infinite linear 1.4s}.wind-west.wind-med .small.weather-9{animation:falling-9-west-med 1.3s infinite linear 1.4s}.wind-west.wind-high .small.weather-9{animation:falling-9-west-high 1.3s infinite linear 1.4s}.small.weather-10{animation:falling-10 3s infinite linear .4s}.wind-east .small.weather-10{animation:falling-10-east 3s infinite linear .4s}.wind-east.wind-med .small.weather-10{animation:falling-10-east-med 3s infinite linear .4s}.wind-east.wind-high .small.weather-10{animation:falling-10-east-high 3s infinite linear .4s}.wind-west .small.weather-10{animation:falling-10-west 3s infinite linear .4s}.wind-west.wind-med .small.weather-10{animation:falling-10-west-med 3s infinite linear .4s}.wind-west.wind-high .small.weather-10{animation:falling-10-west-high 3s infinite linear .4s}.large.weather{height:30px;width:16px;background:rgba(100,130,255,0.9)}.large.weather-1{animation:falling-1 2.7s infinite linear .2s}.wind-east .large.weather-1{animation:falling-1-east 2.7s infinite linear .2s}.wind-east.wind-med .large.weather-1{animation:falling-1-east-med 2.7s infinite linear .2s}.wind-east.wind-high .large.weather-1{animation:falling-1-east-high 2.7s infinite linear .2s}.wind-west .large.weather-1{animation:falling-1-west 2.7s infinite linear .2s}.wind-west.wind-med .large.weather-1{animation:falling-1-west-med 2.7s infinite linear .2s}.wind-west.wind-high .large.weather-1{animation:falling-1-west-high 2.7s infinite linear .2s}.large.weather-2{animation:falling-2 1.4s infinite linear 1.2s}.wind-east .large.weather-2{animation:falling-2-east 1.4s infinite linear 1.2s}.wind-east.wind-med .large.weather-2{animation:falling-2-east-med 1.4s infinite linear 1.2s}.wind-east.wind-high .large.weather-2{animation:falling-2-east-high 1.4s infinite linear 1.2s}.wind-west .large.weather-2{animation:falling-2-west 1.4s infinite linear 1.2s}.wind-west.wind-med .large.weather-2{animation:falling-2-west-med 1.4s infinite linear 1.2s}.wind-west.wind-high .large.weather-2{animation:falling-2-west-high 1.4s infinite linear 1.2s}.large.weather-3{animation:falling-3 1.7s infinite linear 1.1s}.wind-east .large.weather-3{animation:falling-3-east 1.7s infinite linear 1.1s}.wind-east.wind-med .large.weather-3{animation:falling-3-east-med 1.7s infinite linear 1.1s}.wind-east.wind-high .large.weather-3{animation:falling-3-east-high 1.7s infinite linear 1.1s}.wind-west .large.weather-3{animation:falling-3-west 1.7s infinite linear 1.1s}.wind-west.wind-med .large.weather-3{animation:falling-3-west-med 1.7s infinite linear 1.1s}.wind-west.wind-high .large.weather-3{animation:falling-3-west-high 1.7s infinite linear 1.1s}.large.weather-4{animation:falling-4 1.9s infinite linear 1.3s}.wind-east .large.weather-4{animation:falling-4-east 1.9s infinite linear 1.3s}.wind-east.wind-med .large.weather-4{animation:falling-4-east-med 1.9s infinite linear 1.3s}.wind-east.wind-high .large.weather-4{animation:falling-4-east-high 1.9s infinite linear 1.3s}.wind-west .large.weather-4{animation:falling-4-west 1.9s infinite linear 1.3s}.wind-west.wind-med .large.weather-4{animation:falling-4-west-med 1.9s infinite linear 1.3s}.wind-west.wind-high .large.weather-4{animation:falling-4-west-high 1.9s infinite linear 1.3s}.large.weather-5{animation:falling-5 2.5s infinite linear 1.4s}.wind-east .large.weather-5{animation:falling-5-east 2.5s infinite linear 1.4s}.wind-east.wind-med .large.weather-5{animation:falling-5-east-med 2.5s infinite linear 1.4s}.wind-east.wind-high .large.weather-5{animation:falling-5-east-high 2.5s infinite linear 1.4s}.wind-west .large.weather-5{animation:falling-5-west 2.5s infinite linear 1.4s}.wind-west.wind-med .large.weather-5{animation:falling-5-west-med 2.5s infinite linear 1.4s}.wind-west.wind-high .large.weather-5{animation:falling-5-west-high 2.5s infinite linear 1.4s}.large.weather-6{animation:falling-6 2.7s infinite linear .7s}.wind-east .large.weather-6{animation:falling-6-east 2.7s infinite linear .7s}.wind-east.wind-med .large.weather-6{animation:falling-6-east-med 2.7s infinite linear .7s}.wind-east.wind-high .large.weather-6{animation:falling-6-east-high 2.7s infinite linear .7s}.wind-west .large.weather-6{animation:falling-6-west 2.7s infinite linear .7s}.wind-west.wind-med .large.weather-6{animation:falling-6-west-med 2.7s infinite linear .7s}.wind-west.wind-high .large.weather-6{animation:falling-6-west-high 2.7s infinite linear .7s}.large.weather-7{animation:falling-7 1.5s infinite linear .2s}.wind-east .large.weather-7{animation:falling-7-east 1.5s infinite linear .2s}.wind-east.wind-med .large.weather-7{animation:falling-7-east-med 1.5s infinite linear .2s}.wind-east.wind-high .large.weather-7{animation:falling-7-east-high 1.5s infinite linear .2s}.wind-west .large.weather-7{animation:falling-7-west 1.5s infinite linear .2s}.wind-west.wind-med .large.weather-7{animation:falling-7-west-med 1.5s infinite linear .2s}.wind-west.wind-high .large.weather-7{animation:falling-7-west-high 1.5s infinite linear .2s}.large.weather-8{animation:falling-8 2.5s infinite linear 1.4s}.wind-east .large.weather-8{animation:falling-8-east 2.5s infinite linear 1.4s}.wind-east.wind-med .large.weather-8{animation:falling-8-east-med 2.5s infinite linear 1.4s}.wind-east.wind-high .large.weather-8{animation:falling-8-east-high 2.5s infinite linear 1.4s}.wind-west .large.weather-8{animation:falling-8-west 2.5s infinite linear 1.4s}.wind-west.wind-med .large.weather-8{animation:falling-8-west-med 2.5s infinite linear 1.4s}.wind-west.wind-high .large.weather-8{animation:falling-8-west-high 2.5s infinite linear 1.4s}.large.weather-9{animation:falling-9 1.4s infinite linear 1.3s}.wind-east .large.weather-9{animation:falling-9-east 1.4s infinite linear 1.3s}.wind-east.wind-med .large.weather-9{animation:falling-9-east-med 1.4s infinite linear 1.3s}.wind-east.wind-high .large.weather-9{animation:falling-9-east-high 1.4s infinite linear 1.3s}.wind-west .large.weather-9{animation:falling-9-west 1.4s infinite linear 1.3s}.wind-west.wind-med .large.weather-9{animation:falling-9-west-med 1.4s infinite linear 1.3s}.wind-west.wind-high .large.weather-9{animation:falling-9-west-high 1.4s infinite linear 1.3s}.large.weather-10{animation:falling-10 1.3s infinite linear .1s}.wind-east .large.weather-10{animation:falling-10-east 1.3s infinite linear .1s}.wind-east.wind-med .large.weather-10{animation:falling-10-east-med 1.3s infinite linear .1s}.wind-east.wind-high .large.weather-10{animation:falling-10-east-high 1.3s infinite linear .1s}.wind-west .large.weather-10{animation:falling-10-west 1.3s infinite linear .1s}.wind-west.wind-med .large.weather-10{animation:falling-10-west-med 1.3s infinite linear .1s}.wind-west.wind-high .large.weather-10{animation:falling-10-west-high 1.3s infinite linear .1s}\n'
                module.exports = require('scssify').createStyle(css, {})
            },
            { scssify: 1 },
        ],
        25: [
            function(require, module, exports) {
                var css =
                    '.cloud,.puff,.cloud:after,.puff:after{position:absolute;background:rgba(255,255,255,0.8);border-radius:50%;z-index:7}.light .cloud,.light .puff,.light .cloud:after,.light .puff:after{background:rgba(255,255,255,0.7);transform:scale(0.7) translateY(-30%)}.heavy .cloud,.heavy .puff,.heavy .cloud:after,.heavy .puff:after{background:rgba(255,255,255,0.9);transform:scale(1.6) translateY(-30%)}.isFalling .cloud,.isFalling .puff,.isFalling .cloud:after,.isFalling .puff:after{background:rgba(255,255,255,0.8)}.cloud,.cloud:after{height:var(--base-width);filter:blur(calc(var(--base-width) * 0.1))}.puff,.puff:after{height:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 2.5);filter:blur(calc(var(--base-width) * 0.15))}.cloud.one{top:calc(var(--base-width) * -0.1);left:calc(var(--base-width) * -0.3);width:calc(var(--base-width) * 5)}.cloud.one:after{width:calc(var(--base-width) * 5)}.cloud.two{top:calc(var(--base-width) * 0.4);left:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 3)}.cloud.two:after{width:calc(var(--base-width) * 3)}.cloud.three{top:calc(var(--base-width) * 0.8);left:calc(var(--base-width) * 1.8);width:calc(var(--base-width) * 4)}.cloud.three:after{width:calc(var(--base-width) * 4)}.puff.one{top:calc(var(--base-width) * 1.2);left:calc(var(--base-width) * 0.2)}.puff.two{top:calc(var(--base-width) * 1.4);left:calc(var(--base-width) * 1.2)}.puff.three{top:calc(var(--base-width) * 0.5);left:calc(var(--base-width) * 3.3)}.isFalling .weather{z-index:6;position:absolute;top:calc(var(--frame-width) / -40);opacity:0;border-radius:50%}.tiny.weather{height:16px;width:8px;background:rgba(100,130,255,0.6)}.weather-1{left:36.36364px}@keyframes falling-1{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:48.86364px}}.wind-east .weather-1{left:36.36364px}@keyframes falling-1-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:13.63636px}}.wind-east.wind-med .weather-1{left:81.81818px}@keyframes falling-1-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-9.09091px}}.wind-east.wind-high .weather-1{left:127.27273px}@keyframes falling-1-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-54.54545px}}.wind-west .weather-1{left:-54.54545px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west.wind-med .weather-1{left:-9.09091px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:81.81818px}}.wind-west.wind-high .weather-1{left:-54.54545px}@keyframes falling-1-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.weather-2{left:72.72727px}@keyframes falling-2{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:85.22727px}}.wind-east .weather-2{left:72.72727px}@keyframes falling-2-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:50px}}.wind-east.wind-med .weather-2{left:118.18182px}@keyframes falling-2-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:27.27273px}}.wind-east.wind-high .weather-2{left:163.63636px}@keyframes falling-2-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-18.18182px}}.wind-west .weather-2{left:-18.18182px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west.wind-med .weather-2{left:27.27273px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:118.18182px}}.wind-west.wind-high .weather-2{left:-18.18182px}@keyframes falling-2-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.weather-3{left:109.09091px}@keyframes falling-3{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:121.59091px}}.wind-east .weather-3{left:109.09091px}@keyframes falling-3-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:86.36364px}}.wind-east.wind-med .weather-3{left:154.54545px}@keyframes falling-3-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:63.63636px}}.wind-east.wind-high .weather-3{left:200px}@keyframes falling-3-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:18.18182px}}.wind-west .weather-3{left:18.18182px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west.wind-med .weather-3{left:63.63636px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:154.54545px}}.wind-west.wind-high .weather-3{left:18.18182px}@keyframes falling-3-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.weather-4{left:145.45455px}@keyframes falling-4{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:157.95455px}}.wind-east .weather-4{left:145.45455px}@keyframes falling-4-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:122.72727px}}.wind-east.wind-med .weather-4{left:190.90909px}@keyframes falling-4-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:100px}}.wind-east.wind-high .weather-4{left:236.36364px}@keyframes falling-4-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:54.54545px}}.wind-west .weather-4{left:54.54545px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west.wind-med .weather-4{left:100px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:190.90909px}}.wind-west.wind-high .weather-4{left:54.54545px}@keyframes falling-4-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.weather-5{left:181.81818px}@keyframes falling-5{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:194.31818px}}.wind-east .weather-5{left:181.81818px}@keyframes falling-5-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:159.09091px}}.wind-east.wind-med .weather-5{left:227.27273px}@keyframes falling-5-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:136.36364px}}.wind-east.wind-high .weather-5{left:272.72727px}@keyframes falling-5-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:90.90909px}}.wind-west .weather-5{left:90.90909px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west.wind-med .weather-5{left:136.36364px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:227.27273px}}.wind-west.wind-high .weather-5{left:90.90909px}@keyframes falling-5-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.weather-6{left:218.18182px}@keyframes falling-6{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:230.68182px}}.wind-east .weather-6{left:218.18182px}@keyframes falling-6-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:195.45455px}}.wind-east.wind-med .weather-6{left:263.63636px}@keyframes falling-6-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:172.72727px}}.wind-east.wind-high .weather-6{left:309.09091px}@keyframes falling-6-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west .weather-6{left:127.27273px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.wind-west.wind-med .weather-6{left:172.72727px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:263.63636px}}.wind-west.wind-high .weather-6{left:127.27273px}@keyframes falling-6-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.weather-7{left:254.54545px}@keyframes falling-7{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:267.04545px}}.wind-east .weather-7{left:254.54545px}@keyframes falling-7-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:231.81818px}}.wind-east.wind-med .weather-7{left:300px}@keyframes falling-7-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:209.09091px}}.wind-east.wind-high .weather-7{left:345.45455px}@keyframes falling-7-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west .weather-7{left:163.63636px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.wind-west.wind-med .weather-7{left:209.09091px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:300px}}.wind-west.wind-high .weather-7{left:163.63636px}@keyframes falling-7-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.weather-8{left:290.90909px}@keyframes falling-8{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:303.40909px}}.wind-east .weather-8{left:290.90909px}@keyframes falling-8-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:268.18182px}}.wind-east.wind-med .weather-8{left:336.36364px}@keyframes falling-8-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:245.45455px}}.wind-east.wind-high .weather-8{left:381.81818px}@keyframes falling-8-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west .weather-8{left:200px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.wind-west.wind-med .weather-8{left:245.45455px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:336.36364px}}.wind-west.wind-high .weather-8{left:200px}@keyframes falling-8-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.weather-9{left:327.27273px}@keyframes falling-9{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:339.77273px}}.wind-east .weather-9{left:327.27273px}@keyframes falling-9-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:304.54545px}}.wind-east.wind-med .weather-9{left:372.72727px}@keyframes falling-9-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:281.81818px}}.wind-east.wind-high .weather-9{left:418.18182px}@keyframes falling-9-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west .weather-9{left:236.36364px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.wind-west.wind-med .weather-9{left:281.81818px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:372.72727px}}.wind-west.wind-high .weather-9{left:236.36364px}@keyframes falling-9-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.weather-10{left:363.63636px}@keyframes falling-10{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:376.13636px}}.wind-east .weather-10{left:363.63636px}@keyframes falling-10-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:340.90909px}}.wind-east.wind-med .weather-10{left:409.09091px}@keyframes falling-10-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:318.18182px}}.wind-east.wind-high .weather-10{left:454.54545px}@keyframes falling-10-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west .weather-10{left:272.72727px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.wind-west.wind-med .weather-10{left:318.18182px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:409.09091px}}.wind-west.wind-high .weather-10{left:272.72727px}@keyframes falling-10-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.tiny.weather-1{animation:falling-1 1.6s infinite linear .7s}.wind-east .tiny.weather-1{animation:falling-1-east 1.6s infinite linear .7s}.wind-east.wind-med .tiny.weather-1{animation:falling-1-east-med 1.6s infinite linear .7s}.wind-east.wind-high .tiny.weather-1{animation:falling-1-east-high 1.6s infinite linear .7s}.wind-west .tiny.weather-1{animation:falling-1-west 1.6s infinite linear .7s}.wind-west.wind-med .tiny.weather-1{animation:falling-1-west-med 1.6s infinite linear .7s}.wind-west.wind-high .tiny.weather-1{animation:falling-1-west-high 1.6s infinite linear .7s}.tiny.weather-2{animation:falling-2 2.2s infinite linear .9s}.wind-east .tiny.weather-2{animation:falling-2-east 2.2s infinite linear .9s}.wind-east.wind-med .tiny.weather-2{animation:falling-2-east-med 2.2s infinite linear .9s}.wind-east.wind-high .tiny.weather-2{animation:falling-2-east-high 2.2s infinite linear .9s}.wind-west .tiny.weather-2{animation:falling-2-west 2.2s infinite linear .9s}.wind-west.wind-med .tiny.weather-2{animation:falling-2-west-med 2.2s infinite linear .9s}.wind-west.wind-high .tiny.weather-2{animation:falling-2-west-high 2.2s infinite linear .9s}.tiny.weather-3{animation:falling-3 2.6s infinite linear .9s}.wind-east .tiny.weather-3{animation:falling-3-east 2.6s infinite linear .9s}.wind-east.wind-med .tiny.weather-3{animation:falling-3-east-med 2.6s infinite linear .9s}.wind-east.wind-high .tiny.weather-3{animation:falling-3-east-high 2.6s infinite linear .9s}.wind-west .tiny.weather-3{animation:falling-3-west 2.6s infinite linear .9s}.wind-west.wind-med .tiny.weather-3{animation:falling-3-west-med 2.6s infinite linear .9s}.wind-west.wind-high .tiny.weather-3{animation:falling-3-west-high 2.6s infinite linear .9s}.tiny.weather-4{animation:falling-4 1.7s infinite linear .4s}.wind-east .tiny.weather-4{animation:falling-4-east 1.7s infinite linear .4s}.wind-east.wind-med .tiny.weather-4{animation:falling-4-east-med 1.7s infinite linear .4s}.wind-east.wind-high .tiny.weather-4{animation:falling-4-east-high 1.7s infinite linear .4s}.wind-west .tiny.weather-4{animation:falling-4-west 1.7s infinite linear .4s}.wind-west.wind-med .tiny.weather-4{animation:falling-4-west-med 1.7s infinite linear .4s}.wind-west.wind-high .tiny.weather-4{animation:falling-4-west-high 1.7s infinite linear .4s}.tiny.weather-5{animation:falling-5 1.2s infinite linear .2s}.wind-east .tiny.weather-5{animation:falling-5-east 1.2s infinite linear .2s}.wind-east.wind-med .tiny.weather-5{animation:falling-5-east-med 1.2s infinite linear .2s}.wind-east.wind-high .tiny.weather-5{animation:falling-5-east-high 1.2s infinite linear .2s}.wind-west .tiny.weather-5{animation:falling-5-west 1.2s infinite linear .2s}.wind-west.wind-med .tiny.weather-5{animation:falling-5-west-med 1.2s infinite linear .2s}.wind-west.wind-high .tiny.weather-5{animation:falling-5-west-high 1.2s infinite linear .2s}.tiny.weather-6{animation:falling-6 2.3s infinite linear .4s}.wind-east .tiny.weather-6{animation:falling-6-east 2.3s infinite linear .4s}.wind-east.wind-med .tiny.weather-6{animation:falling-6-east-med 2.3s infinite linear .4s}.wind-east.wind-high .tiny.weather-6{animation:falling-6-east-high 2.3s infinite linear .4s}.wind-west .tiny.weather-6{animation:falling-6-west 2.3s infinite linear .4s}.wind-west.wind-med .tiny.weather-6{animation:falling-6-west-med 2.3s infinite linear .4s}.wind-west.wind-high .tiny.weather-6{animation:falling-6-west-high 2.3s infinite linear .4s}.tiny.weather-7{animation:falling-7 2s infinite linear .4s}.wind-east .tiny.weather-7{animation:falling-7-east 2s infinite linear .4s}.wind-east.wind-med .tiny.weather-7{animation:falling-7-east-med 2s infinite linear .4s}.wind-east.wind-high .tiny.weather-7{animation:falling-7-east-high 2s infinite linear .4s}.wind-west .tiny.weather-7{animation:falling-7-west 2s infinite linear .4s}.wind-west.wind-med .tiny.weather-7{animation:falling-7-west-med 2s infinite linear .4s}.wind-west.wind-high .tiny.weather-7{animation:falling-7-west-high 2s infinite linear .4s}.tiny.weather-8{animation:falling-8 2.4s infinite linear .6s}.wind-east .tiny.weather-8{animation:falling-8-east 2.4s infinite linear .6s}.wind-east.wind-med .tiny.weather-8{animation:falling-8-east-med 2.4s infinite linear .6s}.wind-east.wind-high .tiny.weather-8{animation:falling-8-east-high 2.4s infinite linear .6s}.wind-west .tiny.weather-8{animation:falling-8-west 2.4s infinite linear .6s}.wind-west.wind-med .tiny.weather-8{animation:falling-8-west-med 2.4s infinite linear .6s}.wind-west.wind-high .tiny.weather-8{animation:falling-8-west-high 2.4s infinite linear .6s}.tiny.weather-9{animation:falling-9 1.2s infinite linear 1.4s}.wind-east .tiny.weather-9{animation:falling-9-east 1.2s infinite linear 1.4s}.wind-east.wind-med .tiny.weather-9{animation:falling-9-east-med 1.2s infinite linear 1.4s}.wind-east.wind-high .tiny.weather-9{animation:falling-9-east-high 1.2s infinite linear 1.4s}.wind-west .tiny.weather-9{animation:falling-9-west 1.2s infinite linear 1.4s}.wind-west.wind-med .tiny.weather-9{animation:falling-9-west-med 1.2s infinite linear 1.4s}.wind-west.wind-high .tiny.weather-9{animation:falling-9-west-high 1.2s infinite linear 1.4s}.tiny.weather-10{animation:falling-10 1.6s infinite linear .1s}.wind-east .tiny.weather-10{animation:falling-10-east 1.6s infinite linear .1s}.wind-east.wind-med .tiny.weather-10{animation:falling-10-east-med 1.6s infinite linear .1s}.wind-east.wind-high .tiny.weather-10{animation:falling-10-east-high 1.6s infinite linear .1s}.wind-west .tiny.weather-10{animation:falling-10-west 1.6s infinite linear .1s}.wind-west.wind-med .tiny.weather-10{animation:falling-10-west-med 1.6s infinite linear .1s}.wind-west.wind-high .tiny.weather-10{animation:falling-10-west-high 1.6s infinite linear .1s}\n'
                module.exports = require('scssify').createStyle(css, {})
            },
            { scssify: 1 },
        ],
        26: [
            function(require, module, exports) {
                var css =
                    '.cloud,.puff,.cloud:after,.puff:after{position:absolute;background:rgba(255,255,255,0.8);border-radius:50%;z-index:7}.light .cloud,.light .puff,.light .cloud:after,.light .puff:after{background:rgba(255,255,255,0.7);transform:scale(0.7) translateY(-30%)}.heavy .cloud,.heavy .puff,.heavy .cloud:after,.heavy .puff:after{background:rgba(255,255,255,0.9);transform:scale(1.6) translateY(-30%)}.isFalling .cloud,.isFalling .puff,.isFalling .cloud:after,.isFalling .puff:after{background:rgba(255,255,255,0.8)}.cloud,.cloud:after{height:var(--base-width);filter:blur(calc(var(--base-width) * 0.1))}.puff,.puff:after{height:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 2.5);filter:blur(calc(var(--base-width) * 0.15))}.cloud.one{top:calc(var(--base-width) * -0.1);left:calc(var(--base-width) * -0.3);width:calc(var(--base-width) * 5)}.cloud.one:after{width:calc(var(--base-width) * 5)}.cloud.two{top:calc(var(--base-width) * 0.4);left:calc(var(--base-width) * 0.8);width:calc(var(--base-width) * 3)}.cloud.two:after{width:calc(var(--base-width) * 3)}.cloud.three{top:calc(var(--base-width) * 0.8);left:calc(var(--base-width) * 1.8);width:calc(var(--base-width) * 4)}.cloud.three:after{width:calc(var(--base-width) * 4)}.puff.one{top:calc(var(--base-width) * 1.2);left:calc(var(--base-width) * 0.2)}.puff.two{top:calc(var(--base-width) * 1.4);left:calc(var(--base-width) * 1.2)}.puff.three{top:calc(var(--base-width) * 0.5);left:calc(var(--base-width) * 3.3)}.isFalling .weather{z-index:6;position:absolute;top:calc(var(--frame-width) / -40);opacity:0;border-radius:50%}.tiny.weather{height:16px;width:8px;background:rgba(100,130,255,0.6)}.weather-1{left:36.36364px}@keyframes falling-1{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:48.86364px}}.wind-east .weather-1{left:36.36364px}@keyframes falling-1-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:13.63636px}}.wind-east.wind-med .weather-1{left:81.81818px}@keyframes falling-1-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-9.09091px}}.wind-east.wind-high .weather-1{left:127.27273px}@keyframes falling-1-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-54.54545px}}.wind-west .weather-1{left:-54.54545px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west.wind-med .weather-1{left:-9.09091px}@keyframes falling-1-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:81.81818px}}.wind-west.wind-high .weather-1{left:-54.54545px}@keyframes falling-1-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.weather-2{left:72.72727px}@keyframes falling-2{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:85.22727px}}.wind-east .weather-2{left:72.72727px}@keyframes falling-2-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:50px}}.wind-east.wind-med .weather-2{left:118.18182px}@keyframes falling-2-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:27.27273px}}.wind-east.wind-high .weather-2{left:163.63636px}@keyframes falling-2-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:-18.18182px}}.wind-west .weather-2{left:-18.18182px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west.wind-med .weather-2{left:27.27273px}@keyframes falling-2-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:118.18182px}}.wind-west.wind-high .weather-2{left:-18.18182px}@keyframes falling-2-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.weather-3{left:109.09091px}@keyframes falling-3{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:121.59091px}}.wind-east .weather-3{left:109.09091px}@keyframes falling-3-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:86.36364px}}.wind-east.wind-med .weather-3{left:154.54545px}@keyframes falling-3-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:63.63636px}}.wind-east.wind-high .weather-3{left:200px}@keyframes falling-3-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:18.18182px}}.wind-west .weather-3{left:18.18182px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west.wind-med .weather-3{left:63.63636px}@keyframes falling-3-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:154.54545px}}.wind-west.wind-high .weather-3{left:18.18182px}@keyframes falling-3-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.weather-4{left:145.45455px}@keyframes falling-4{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:157.95455px}}.wind-east .weather-4{left:145.45455px}@keyframes falling-4-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:122.72727px}}.wind-east.wind-med .weather-4{left:190.90909px}@keyframes falling-4-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:100px}}.wind-east.wind-high .weather-4{left:236.36364px}@keyframes falling-4-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:54.54545px}}.wind-west .weather-4{left:54.54545px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west.wind-med .weather-4{left:100px}@keyframes falling-4-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:190.90909px}}.wind-west.wind-high .weather-4{left:54.54545px}@keyframes falling-4-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.weather-5{left:181.81818px}@keyframes falling-5{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:194.31818px}}.wind-east .weather-5{left:181.81818px}@keyframes falling-5-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:159.09091px}}.wind-east.wind-med .weather-5{left:227.27273px}@keyframes falling-5-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:136.36364px}}.wind-east.wind-high .weather-5{left:272.72727px}@keyframes falling-5-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:90.90909px}}.wind-west .weather-5{left:90.90909px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west.wind-med .weather-5{left:136.36364px}@keyframes falling-5-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:227.27273px}}.wind-west.wind-high .weather-5{left:90.90909px}@keyframes falling-5-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.weather-6{left:218.18182px}@keyframes falling-6{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:230.68182px}}.wind-east .weather-6{left:218.18182px}@keyframes falling-6-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:195.45455px}}.wind-east.wind-med .weather-6{left:263.63636px}@keyframes falling-6-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:172.72727px}}.wind-east.wind-high .weather-6{left:309.09091px}@keyframes falling-6-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:127.27273px}}.wind-west .weather-6{left:127.27273px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.wind-west.wind-med .weather-6{left:172.72727px}@keyframes falling-6-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:263.63636px}}.wind-west.wind-high .weather-6{left:127.27273px}@keyframes falling-6-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:309.09091px}}.weather-7{left:254.54545px}@keyframes falling-7{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:267.04545px}}.wind-east .weather-7{left:254.54545px}@keyframes falling-7-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:231.81818px}}.wind-east.wind-med .weather-7{left:300px}@keyframes falling-7-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:209.09091px}}.wind-east.wind-high .weather-7{left:345.45455px}@keyframes falling-7-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:163.63636px}}.wind-west .weather-7{left:163.63636px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.wind-west.wind-med .weather-7{left:209.09091px}@keyframes falling-7-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:300px}}.wind-west.wind-high .weather-7{left:163.63636px}@keyframes falling-7-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:345.45455px}}.weather-8{left:290.90909px}@keyframes falling-8{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:303.40909px}}.wind-east .weather-8{left:290.90909px}@keyframes falling-8-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:268.18182px}}.wind-east.wind-med .weather-8{left:336.36364px}@keyframes falling-8-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:245.45455px}}.wind-east.wind-high .weather-8{left:381.81818px}@keyframes falling-8-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:200px}}.wind-west .weather-8{left:200px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.wind-west.wind-med .weather-8{left:245.45455px}@keyframes falling-8-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:336.36364px}}.wind-west.wind-high .weather-8{left:200px}@keyframes falling-8-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:381.81818px}}.weather-9{left:327.27273px}@keyframes falling-9{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:339.77273px}}.wind-east .weather-9{left:327.27273px}@keyframes falling-9-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:304.54545px}}.wind-east.wind-med .weather-9{left:372.72727px}@keyframes falling-9-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:281.81818px}}.wind-east.wind-high .weather-9{left:418.18182px}@keyframes falling-9-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:236.36364px}}.wind-west .weather-9{left:236.36364px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.wind-west.wind-med .weather-9{left:281.81818px}@keyframes falling-9-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:372.72727px}}.wind-west.wind-high .weather-9{left:236.36364px}@keyframes falling-9-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:418.18182px}}.weather-10{left:363.63636px}@keyframes falling-10{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:376.13636px}}.wind-east .weather-10{left:363.63636px}@keyframes falling-10-east{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:340.90909px}}.wind-east.wind-med .weather-10{left:409.09091px}@keyframes falling-10-east-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:318.18182px}}.wind-east.wind-high .weather-10{left:454.54545px}@keyframes falling-10-east-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:272.72727px}}.wind-west .weather-10{left:272.72727px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.wind-west.wind-med .weather-10{left:318.18182px}@keyframes falling-10-west-med{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:409.09091px}}.wind-west.wind-high .weather-10{left:272.72727px}@keyframes falling-10-west-high{100%{opacity:.4;top:calc(var(--weather-height) + var(--weather-height) / 4);left:454.54545px}}.tiny.weather-1{animation:falling-1 1.8s infinite linear .7s}.wind-east .tiny.weather-1{animation:falling-1-east 1.8s infinite linear .7s}.wind-east.wind-med .tiny.weather-1{animation:falling-1-east-med 1.8s infinite linear .7s}.wind-east.wind-high .tiny.weather-1{animation:falling-1-east-high 1.8s infinite linear .7s}.wind-west .tiny.weather-1{animation:falling-1-west 1.8s infinite linear .7s}.wind-west.wind-med .tiny.weather-1{animation:falling-1-west-med 1.8s infinite linear .7s}.wind-west.wind-high .tiny.weather-1{animation:falling-1-west-high 1.8s infinite linear .7s}.tiny.weather-2{animation:falling-2 2s infinite linear .4s}.wind-east .tiny.weather-2{animation:falling-2-east 2s infinite linear .4s}.wind-east.wind-med .tiny.weather-2{animation:falling-2-east-med 2s infinite linear .4s}.wind-east.wind-high .tiny.weather-2{animation:falling-2-east-high 2s infinite linear .4s}.wind-west .tiny.weather-2{animation:falling-2-west 2s infinite linear .4s}.wind-west.wind-med .tiny.weather-2{animation:falling-2-west-med 2s infinite linear .4s}.wind-west.wind-high .tiny.weather-2{animation:falling-2-west-high 2s infinite linear .4s}.tiny.weather-3{animation:falling-3 1.6s infinite linear 1.2s}.wind-east .tiny.weather-3{animation:falling-3-east 1.6s infinite linear 1.2s}.wind-east.wind-med .tiny.weather-3{animation:falling-3-east-med 1.6s infinite linear 1.2s}.wind-east.wind-high .tiny.weather-3{animation:falling-3-east-high 1.6s infinite linear 1.2s}.wind-west .tiny.weather-3{animation:falling-3-west 1.6s infinite linear 1.2s}.wind-west.wind-med .tiny.weather-3{animation:falling-3-west-med 1.6s infinite linear 1.2s}.wind-west.wind-high .tiny.weather-3{animation:falling-3-west-high 1.6s infinite linear 1.2s}.tiny.weather-4{animation:falling-4 2.4s infinite linear 1.1s}.wind-east .tiny.weather-4{animation:falling-4-east 2.4s infinite linear 1.1s}.wind-east.wind-med .tiny.weather-4{animation:falling-4-east-med 2.4s infinite linear 1.1s}.wind-east.wind-high .tiny.weather-4{animation:falling-4-east-high 2.4s infinite linear 1.1s}.wind-west .tiny.weather-4{animation:falling-4-west 2.4s infinite linear 1.1s}.wind-west.wind-med .tiny.weather-4{animation:falling-4-west-med 2.4s infinite linear 1.1s}.wind-west.wind-high .tiny.weather-4{animation:falling-4-west-high 2.4s infinite linear 1.1s}.tiny.weather-5{animation:falling-5 2.9s infinite linear 1.3s}.wind-east .tiny.weather-5{animation:falling-5-east 2.9s infinite linear 1.3s}.wind-east.wind-med .tiny.weather-5{animation:falling-5-east-med 2.9s infinite linear 1.3s}.wind-east.wind-high .tiny.weather-5{animation:falling-5-east-high 2.9s infinite linear 1.3s}.wind-west .tiny.weather-5{animation:falling-5-west 2.9s infinite linear 1.3s}.wind-west.wind-med .tiny.weather-5{animation:falling-5-west-med 2.9s infinite linear 1.3s}.wind-west.wind-high .tiny.weather-5{animation:falling-5-west-high 2.9s infinite linear 1.3s}.tiny.weather-6{animation:falling-6 2.7s infinite linear .8s}.wind-east .tiny.weather-6{animation:falling-6-east 2.7s infinite linear .8s}.wind-east.wind-med .tiny.weather-6{animation:falling-6-east-med 2.7s infinite linear .8s}.wind-east.wind-high .tiny.weather-6{animation:falling-6-east-high 2.7s infinite linear .8s}.wind-west .tiny.weather-6{animation:falling-6-west 2.7s infinite linear .8s}.wind-west.wind-med .tiny.weather-6{animation:falling-6-west-med 2.7s infinite linear .8s}.wind-west.wind-high .tiny.weather-6{animation:falling-6-west-high 2.7s infinite linear .8s}.tiny.weather-7{animation:falling-7 2.5s infinite linear 1.4s}.wind-east .tiny.weather-7{animation:falling-7-east 2.5s infinite linear 1.4s}.wind-east.wind-med .tiny.weather-7{animation:falling-7-east-med 2.5s infinite linear 1.4s}.wind-east.wind-high .tiny.weather-7{animation:falling-7-east-high 2.5s infinite linear 1.4s}.wind-west .tiny.weather-7{animation:falling-7-west 2.5s infinite linear 1.4s}.wind-west.wind-med .tiny.weather-7{animation:falling-7-west-med 2.5s infinite linear 1.4s}.wind-west.wind-high .tiny.weather-7{animation:falling-7-west-high 2.5s infinite linear 1.4s}.tiny.weather-8{animation:falling-8 2.3s infinite linear 1.3s}.wind-east .tiny.weather-8{animation:falling-8-east 2.3s infinite linear 1.3s}.wind-east.wind-med .tiny.weather-8{animation:falling-8-east-med 2.3s infinite linear 1.3s}.wind-east.wind-high .tiny.weather-8{animation:falling-8-east-high 2.3s infinite linear 1.3s}.wind-west .tiny.weather-8{animation:falling-8-west 2.3s infinite linear 1.3s}.wind-west.wind-med .tiny.weather-8{animation:falling-8-west-med 2.3s infinite linear 1.3s}.wind-west.wind-high .tiny.weather-8{animation:falling-8-west-high 2.3s infinite linear 1.3s}.tiny.weather-9{animation:falling-9 2.3s infinite linear .6s}.wind-east .tiny.weather-9{animation:falling-9-east 2.3s infinite linear .6s}.wind-east.wind-med .tiny.weather-9{animation:falling-9-east-med 2.3s infinite linear .6s}.wind-east.wind-high .tiny.weather-9{animation:falling-9-east-high 2.3s infinite linear .6s}.wind-west .tiny.weather-9{animation:falling-9-west 2.3s infinite linear .6s}.wind-west.wind-med .tiny.weather-9{animation:falling-9-west-med 2.3s infinite linear .6s}.wind-west.wind-high .tiny.weather-9{animation:falling-9-west-high 2.3s infinite linear .6s}.tiny.weather-10{animation:falling-10 2.3s infinite linear 1.1s}.wind-east .tiny.weather-10{animation:falling-10-east 2.3s infinite linear 1.1s}.wind-east.wind-med .tiny.weather-10{animation:falling-10-east-med 2.3s infinite linear 1.1s}.wind-east.wind-high .tiny.weather-10{animation:falling-10-east-high 2.3s infinite linear 1.1s}.wind-west .tiny.weather-10{animation:falling-10-west 2.3s infinite linear 1.1s}.wind-west.wind-med .tiny.weather-10{animation:falling-10-west-med 2.3s infinite linear 1.1s}.wind-west.wind-high .tiny.weather-10{animation:falling-10-west-high 2.3s infinite linear 1.1s}.small.weather{height:26px;width:13px;background:rgba(100,130,255,0.75)}.small.weather-1{animation:falling-1 2s infinite linear 1.3s}.wind-east .small.weather-1{animation:falling-1-east 2s infinite linear 1.3s}.wind-east.wind-med .small.weather-1{animation:falling-1-east-med 2s infinite linear 1.3s}.wind-east.wind-high .small.weather-1{animation:falling-1-east-high 2s infinite linear 1.3s}.wind-west .small.weather-1{animation:falling-1-west 2s infinite linear 1.3s}.wind-west.wind-med .small.weather-1{animation:falling-1-west-med 2s infinite linear 1.3s}.wind-west.wind-high .small.weather-1{animation:falling-1-west-high 2s infinite linear 1.3s}.small.weather-2{animation:falling-2 2.8s infinite linear .1s}.wind-east .small.weather-2{animation:falling-2-east 2.8s infinite linear .1s}.wind-east.wind-med .small.weather-2{animation:falling-2-east-med 2.8s infinite linear .1s}.wind-east.wind-high .small.weather-2{animation:falling-2-east-high 2.8s infinite linear .1s}.wind-west .small.weather-2{animation:falling-2-west 2.8s infinite linear .1s}.wind-west.wind-med .small.weather-2{animation:falling-2-west-med 2.8s infinite linear .1s}.wind-west.wind-high .small.weather-2{animation:falling-2-west-high 2.8s infinite linear .1s}.small.weather-3{animation:falling-3 2.2s infinite linear .6s}.wind-east .small.weather-3{animation:falling-3-east 2.2s infinite linear .6s}.wind-east.wind-med .small.weather-3{animation:falling-3-east-med 2.2s infinite linear .6s}.wind-east.wind-high .small.weather-3{animation:falling-3-east-high 2.2s infinite linear .6s}.wind-west .small.weather-3{animation:falling-3-west 2.2s infinite linear .6s}.wind-west.wind-med .small.weather-3{animation:falling-3-west-med 2.2s infinite linear .6s}.wind-west.wind-high .small.weather-3{animation:falling-3-west-high 2.2s infinite linear .6s}.small.weather-4{animation:falling-4 1.8s infinite linear .7s}.wind-east .small.weather-4{animation:falling-4-east 1.8s infinite linear .7s}.wind-east.wind-med .small.weather-4{animation:falling-4-east-med 1.8s infinite linear .7s}.wind-east.wind-high .small.weather-4{animation:falling-4-east-high 1.8s infinite linear .7s}.wind-west .small.weather-4{animation:falling-4-west 1.8s infinite linear .7s}.wind-west.wind-med .small.weather-4{animation:falling-4-west-med 1.8s infinite linear .7s}.wind-west.wind-high .small.weather-4{animation:falling-4-west-high 1.8s infinite linear .7s}.small.weather-5{animation:falling-5 1.7s infinite linear .3s}.wind-east .small.weather-5{animation:falling-5-east 1.7s infinite linear .3s}.wind-east.wind-med .small.weather-5{animation:falling-5-east-med 1.7s infinite linear .3s}.wind-east.wind-high .small.weather-5{animation:falling-5-east-high 1.7s infinite linear .3s}.wind-west .small.weather-5{animation:falling-5-west 1.7s infinite linear .3s}.wind-west.wind-med .small.weather-5{animation:falling-5-west-med 1.7s infinite linear .3s}.wind-west.wind-high .small.weather-5{animation:falling-5-west-high 1.7s infinite linear .3s}.small.weather-6{animation:falling-6 2.6s infinite linear 1.1s}.wind-east .small.weather-6{animation:falling-6-east 2.6s infinite linear 1.1s}.wind-east.wind-med .small.weather-6{animation:falling-6-east-med 2.6s infinite linear 1.1s}.wind-east.wind-high .small.weather-6{animation:falling-6-east-high 2.6s infinite linear 1.1s}.wind-west .small.weather-6{animation:falling-6-west 2.6s infinite linear 1.1s}.wind-west.wind-med .small.weather-6{animation:falling-6-west-med 2.6s infinite linear 1.1s}.wind-west.wind-high .small.weather-6{animation:falling-6-west-high 2.6s infinite linear 1.1s}.small.weather-7{animation:falling-7 1.4s infinite linear 1.4s}.wind-east .small.weather-7{animation:falling-7-east 1.4s infinite linear 1.4s}.wind-east.wind-med .small.weather-7{animation:falling-7-east-med 1.4s infinite linear 1.4s}.wind-east.wind-high .small.weather-7{animation:falling-7-east-high 1.4s infinite linear 1.4s}.wind-west .small.weather-7{animation:falling-7-west 1.4s infinite linear 1.4s}.wind-west.wind-med .small.weather-7{animation:falling-7-west-med 1.4s infinite linear 1.4s}.wind-west.wind-high .small.weather-7{animation:falling-7-west-high 1.4s infinite linear 1.4s}.small.weather-8{animation:falling-8 1.9s infinite linear 1.2s}.wind-east .small.weather-8{animation:falling-8-east 1.9s infinite linear 1.2s}.wind-east.wind-med .small.weather-8{animation:falling-8-east-med 1.9s infinite linear 1.2s}.wind-east.wind-high .small.weather-8{animation:falling-8-east-high 1.9s infinite linear 1.2s}.wind-west .small.weather-8{animation:falling-8-west 1.9s infinite linear 1.2s}.wind-west.wind-med .small.weather-8{animation:falling-8-west-med 1.9s infinite linear 1.2s}.wind-west.wind-high .small.weather-8{animation:falling-8-west-high 1.9s infinite linear 1.2s}.small.weather-9{animation:falling-9 1.5s infinite linear 1s}.wind-east .small.weather-9{animation:falling-9-east 1.5s infinite linear 1s}.wind-east.wind-med .small.weather-9{animation:falling-9-east-med 1.5s infinite linear 1s}.wind-east.wind-high .small.weather-9{animation:falling-9-east-high 1.5s infinite linear 1s}.wind-west .small.weather-9{animation:falling-9-west 1.5s infinite linear 1s}.wind-west.wind-med .small.weather-9{animation:falling-9-west-med 1.5s infinite linear 1s}.wind-west.wind-high .small.weather-9{animation:falling-9-west-high 1.5s infinite linear 1s}.small.weather-10{animation:falling-10 1.5s infinite linear 1.2s}.wind-east .small.weather-10{animation:falling-10-east 1.5s infinite linear 1.2s}.wind-east.wind-med .small.weather-10{animation:falling-10-east-med 1.5s infinite linear 1.2s}.wind-east.wind-high .small.weather-10{animation:falling-10-east-high 1.5s infinite linear 1.2s}.wind-west .small.weather-10{animation:falling-10-west 1.5s infinite linear 1.2s}.wind-west.wind-med .small.weather-10{animation:falling-10-west-med 1.5s infinite linear 1.2s}.wind-west.wind-high .small.weather-10{animation:falling-10-west-high 1.5s infinite linear 1.2s}\n'
                module.exports = require('scssify').createStyle(css, {})
            },
            { scssify: 1 },
        ],
